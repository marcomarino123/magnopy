...
def test_init_from_matrix(matrix):
    parameter = MatrixParameter(matrix=matrix)
...
def test_init_from_aniso(a, b, c):
    ...
    parameter = MatrixParameter(aniso=aniso)
...
@given(ARRAY_3X3, st.floats(min_value=-MAX_MODULUS, max_value=MAX_MODULUS))
def test_iso(matrix, new_iso):
    ...
    assert np.allclose(parameter.iso, parameter.I)
...
def test_aniso(matrix, a, b, c):
    ...
    assert np.allclose(parameter.aniso, parameter.S)
...
#                                 Legacy Tests                                 #
################################################################################
class TestMatrixParameter:
    parameter = MatrixParameter([[1, 5, 2], [5, 8, 4], [2, 6, 3]])

    def test_init(self):
        parameter = MatrixParameter(iso=23)
    ...
    def test_symm_assym_matrix(self):
        parameter = MatrixParameter(matrix=[[1, 2, 0], [1, 1, 0], [0, 0, 1]])
        assert (
    ...
    def test_add(self):
        parameter1 = MatrixParameter(iso=1)
        parameter2 = MatrixParameter(iso=2)
        parameter3 = MatrixParameter(iso=3)
    ...
    def test_matmul(self):
        parameter = MatrixParameter(iso=3, dmi=[1, 0, 0])
    ...
    def test_floordiv(self):
        parameter1 = MatrixParameter(iso=23.4345)
        parameter = parameter1 // 5
