...
import numpy as np
from wulfric import REL_TOL

from magnopy.spinham.hamiltonian import SpinHamiltonian


def load_tb2j(filename, quiet=True, bravais_type=None) -> SpinHamiltonian:
    r"""
    ...
    bravais_type : str, default None
        ...
        The bravais lattice type is reached by reducing the accuracy for the #TODO.
